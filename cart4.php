...
<h3 style="margin-left:400px; ">Total Price: $<?php echo calculateTotalPrice($cartItems); ?></h3>
<div class="buy-button">
    <div class="clear-button" style="margin-left:300px; ">         <form method="GET" action="clear_cart.php">
            <button type="submit">Clear</button>
        </form>
    </div>
    <div class="close-button" style="margin-left:200px; ">
        <a href="customer-profile.php">Close</a>
    </div>
</div>
<?php else: ?>
<p>Your cart is empty.</p>
<button type="btn"  class="btn-btn-success text-light p-5 "><a href="customer-profile.php">Start Shopping</a></button>
<?php endif; ?>
