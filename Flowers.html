...
<body>
   <!-- <div id="preloader-active">
    ...
    <header>
        ...
        <!-- Header End -->
    <div class="container">
    <div class="text-center display-6 text-dark mb-4">Flower categories</div>
    <!--<div class="flowers ">
        <div class="product-tile1">

            <span>Roses</span>

        </div>
        <div class="product-tile2">
            <span>
                Mixed Roses
            </span>
        </div>
        <div class="product-tile3">
            <span>
                lilies
            </span>
        </div>
        <div class="product-tile4">
            <span>
                Carnations
            </span>
        </div>
        <div class="product-tile5">
            <span>
                Fillers and Foliages
            </span>
        </div>
        <div class="product-tile6">
            <span>Astroemelia</span>
        </div>-->
       
        <div class="row">
<form action="Roses.php">
    <div class="col-lg-4 col-md-6 col sm-12 rounded" >
        <div class="card text-center " style="background-color: lime">
            <a href=""><img src="img/roses.jpg" class="card-img-top" alt="Card Image" height="250px" ></a>
            <div class="card-body">
