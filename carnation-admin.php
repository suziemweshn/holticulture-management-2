...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['delete'])) {
        ...
        // Delete the product from the database
        $deleteQuery = "DELETE FROM  carnations WHERE id = $productId";
        mysqli_query($conn, $deleteQuery);
    ...
    if (isset($_POST['edit'])) {
        ...
        // Update the product in the database
        $updateQuery = "UPDATE carnations SET name = '$name', description = '$description', price = $price WHERE id = $productId";
        mysqli_query($conn, $updateQuery);
    }
    ...
    if (isset($_POST['add'])) {
        ...
        $query = "INSERT INTO carnations (name, description, price, image) VALUES ('$name', '$description', $price, '$image')";
...
<header>
    ...
    <div class="heading mt-20 mb-20">
        <h3>Carnations page</h3>
    </div>

    <!-- Add Product Form -->
    <div class="container w-100">
        <div class="product-form">
            <form method="POST" action="carnation-admin.php" class="d-flex flex-row flex-wrap mt-20" enctype="multipart/form-data">
