          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
            ...
            <li class="notification-item">
              ...
              <div>
                ...
                <p>You have acquired one new lead weekly</p>
                <p>30 min. ago</p>
              </div>
            </li>
            ...
            <li class="notification-item">
              ...
              <div>
                <h4>credits</h4>
                <p> Your credit card has expired pelae update your biling details</p>
                <p>1 hr. ago</p>
              </div>
            </li>
            ...
            <li class="notification-item">
              ...
              <div>
                <h4>Update</h4>
                <p>Your services has been updated</p>
                <p>2 hrs. ago</p>
              </div>
            </li>
            <li>
            ...
            <li class="notification-item">
              ...
              <div>
                <h4>Hangout</h4>
                <p>user@suzie has declined your invitation to the Admin's group</p>
                <p>4 hrs. ago</p>
              </div>
            </li>
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
            ...
            <li class="message-item">
              <a href="messages.html">
                ...
                <div>
                  <h4>Maria Hudson</h4>
                  <p>Hello am trying to order some Flowers but my order button not reponsing please...help me in this</p>
                  <p>4 hrs. ago</p>
                </div>
              </a>
            </li>
            ...
            <li class="message-item">
              <a href="messages.html">
                ...
                <div>
                  <h4>Anna Nelson</h4>
                  <p>Hello...This is to inform you that we have a  stafff meeting on wednesday afternoon at teh board room.</p>
                  <p>6 hrs. ago</p>
                </div>
              </a>
            </li>
            ...
            <li class="message-item">
              <a href="messages.html">
                <img src="assets/img/messages-3.jpg" alt="" class="rounded-circle" height="100px" width="100px">
                <div>
                  <h4>David Muldon</h4>
                  <p>Hey there...there are no seedlings available for brocolli...please look at that</p>
                  <p>8 hrs. ago</p>
                </div>
              </a>
            </li>
            ...
            <li class="message-item">
              <a href="messages.html">
                <img src="assets/img/news-1.jpg" alt="" class="rounded-circle" height="100px" width="100px">
                <div>
                  <h4>Eliking johnes</h4>
                  <p>Greetings...just wanted to inform you about teh order I made yesterday ahs not yet arrived.</p>
                  <p>8 hrs. ago</p>
                </div>
              </a>
            </li>
 ...
 <!-- <aside id="sidebar" class="sidebar">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="Admin-portal.html">Home</a></li>
    ...
    <section class="section faq d-flex flex-column-reverse ">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card basic">
            <div class="card-body">
              ...
              <div>
                <h6>1.Where aare you located?</h6>
                <p>We are located at Ndagani that is on meru - nairobi highway Mkamba Plaza Second floor</p>
              </div>

              <div class="pt-2">
                <h6>2. Can I get Planting seedlings in your company?</h6>
                <p>Yes please visit the farm or contact us to know on how you can get tehm.</p>
              </div>

              <div class="pt-2">
                <h6>3. Do you have manufacturing industry in your company?.</p>
              </div>
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Recently asked Questions</h5>
              ...
              <div class="accordion accordion-flush" id="faq-group-1">
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    ...
                    Do you have other branches or its teh main branch?
                    </button>
                  </h2>
                  <div id="faqsOne-1" class="accordion-collapse collapse" data-bs-parent="#faq-group-1">
                    <div class="accordion-body">
               Yes we have other branches around the country in Nairobi Eldoret, Kisumu as well as Nanyuki
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed" data-bs-target="#faqsOne-2" type="button" data-bs-toggle="collapse">
                      Do I pay the delivery fee after ordering?
                    </button>
                  </h2>
                  <div id="faqsOne-2" class="accordion-collapse collapse" data-bs-parent="#faq-group-1">
                    <div class="accordion-body">
                   You order we deliver for free... We offer free delivery
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed" data-bs-target="#faqsOne-3" type="button" data-bs-toggle="collapse">
                     Are you hiring workers right now?
                    </button>
                  </h2>
                  <div id="faqsOne-3" class="accordion-collapse collapse" data-bs-parent="#faq-group-1">
                    <div class="accordion-body">
                 We hire our workers at June and December..please fill out the form to get the notifications when we are hiring.
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header">
                    <button class="accordion-button collapsed" data-bs-target="#faqsOne-4" type="button" data-bs-toggle="collapse">
                     Do you offer attachments an dinternships?
                    </button>
                  </h2>
                  <div id="faqsOne-4" class="accordion-collapse collapse" data-bs-parent="#faq-group-1">
                    <div class="accordion-body">
                    We train the youth in our company so that they can grow tehir skills on various fields.we offer the internship for six months.
                    </div>
                  </div>
                </div>
